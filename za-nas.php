...
<main>
    <section class="page-content">
        ...
        <div class="about-detail">
            ...
            <p>Изпълняваме както външни, така и вътрешни инсталации.</p>

            <div class="about-features" style="margin-top: 3rem;">
                <div class="feature-item">
                    <span class="feature-number">30+</span>
                    <span class="feature-label">Завършени проекти</span>
                </div>
                <div class="feature-item">
                    <span class="feature-number">21</span>
                    <span class="feature-label">Единици техника</span>
                </div>
                <div class="feature-item">
                    <span class="feature-number">100%</span>
                    <span class="feature-label">Качество</span>
                </div>
            </div>
        </div>
    </section>
